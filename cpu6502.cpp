...
IRAM_ATTR void Cpu6502::scanlineClock()
{
...
{
    if (apu.DMC_DMA_dummy) apu.DMC_DMA_dummy = false;
    else
    {
        // if (apu.DMC_DMA_alignment)
        // {
        //     if (system_clock_counter & 1 == 1)
        //         apu.DMC_DMA_alignment = false;
        // }
        // else
        // {
        //     apu.setDMCBuffer(read(apu.getDMCAddress()));
...
inline IRAM_ATTR void Cpu6502::DMC_DMA_Reload()
{
    if (apu.DMC_DMA_dummy) apu.DMC_DMA_dummy = false;
    else
    {
